/*
  ...
  1. New Tables
    - `friendships` - Stores friendship connections between users
      - `id` (uuid, primary key)
  ...
  2. Security
    ...
    - Add policies for viewing, creating, updating, and deleting friendships and requests
  
  3. Functions
    - Friend request management (send, accept, reject)
    - Friend management (remove)
    - Friend listing and searching
