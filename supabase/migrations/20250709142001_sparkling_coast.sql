/*
  ...
  1. Changes
     - Drop and recreate get_friends() function with correct return type
     - Drop and recreate get_friend_requests() function with correct column references
     - Add account_deletion request and cancel functions
*/
