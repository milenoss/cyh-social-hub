/*
  ...
  2. Security
    ...
    - Users can only see their own friendships and friend requests
  ...
  3. Functions
    ...
    - `get_friend_requests()` - Get sent and received friend requests
    - `get_friends()` - Get user's friends list
    - `search_users()` - Search for users to send friend requests
    - `get_friend_suggestions()` - Get friend suggestions based on mutual connections
    - `check_friendship_status()` - Check relationship status between two users
*/
...
DO $$ 
BEGIN
  -- Drop friendships policies if they exist
  ...
  DROP POLICY IF EXISTS "Users can view friend requests they've sent or received" ON friend_requests;
  DROP POLICY IF EXISTS "Users can send friend requests" ON friend_requests;
  DROP POLICY IF EXISTS "Users can update friend requests they've received" ON friend_requests;
  DROP POLICY IF EXISTS "Users can delete friend requests they've sent or received" ON friend_requests;
END $$;
