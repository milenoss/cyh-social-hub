...
function Chrome({ children }: { children: React.ReactNode }) {
  return <><a className="skip-link" href="#main">Skip to content</a><header className="site-nav shell"><Brand /><nav className="nav-links" aria-label="Primary navigation"><Link to="/#how">How it works</Link><Link to="/#crew">Crew</Link><NavLink to="/support">Support</NavLink><Link className="nav-cta" to="/#launch">Ask about testing</Link></nav></header><main id="main">{children}</main><footer><div className="footer-inner shell"><div className="footer-lockup">Choose the hard that takes you somewhere.</div><nav className="footer-links" aria-label="Footer navigation"><Link to="/terms">Terms</Link><Link to="/privacy">Privacy</Link><Link to="/support">Support</Link><Link to="/delete-account">Account deletion</Link></nav></div></footer></>;
}
